...
class C22InterceptingLogsSpec extends TestKit(ActorSystem("InterceptingLogsSpec", ConfigFactory.load().getConfig("interceptingLogMessages")))
  with ImplicitSender
  ...
  import C22InterceptingLogsSpec._
...
object C22InterceptingLogsSpec {
